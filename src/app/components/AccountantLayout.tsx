...
import { AlertTriangle, BookCheck, FilePenLine, LayoutDashboard, LogOut, SearchCheck } from 'lucide-react';
import { useAuth } from '../context/AuthContext';

const accountantLinks = [
  { to: '/accountant/journals', label: 'Journal Review', icon: BookCheck },
  { to: '/accountant/reconciliations', label: 'Reconciliation', icon: SearchCheck },
  { to: '/accountant/adjustments', label: 'Adjustments', icon: FilePenLine },
  { to: '/accountant/exceptions', label: 'Exceptions', icon: AlertTriangle },
];
